...
- **Built and deployed** a FastAPI REST service exposing CRAG as HTTP and Server-Sent Events (SSE) streaming endpoints with in-memory session management, PDF ingestion into ChromaDB, and LangSmith observability — containerised with Docker and published to DockerHub
